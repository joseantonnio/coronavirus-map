<?php 
    $title = "Doação Confirmada - Mapa do Coronavírus no Brasil";
    $description = "Muito obrigado pelo copão café forte e quente. Você fez um desenvolvedor muito mais feliz hoje!";
?>
