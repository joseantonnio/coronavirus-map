...
if (document.location.toString().indexOf('?') !== -1) {
  var query = document.location.toString() // get the query string
...
$.ajax({
  ...
  success: function success(data) {
    ...
    for (var i = 0; i < markers.length; ++i) {
      var popup = markers[i].city.name + '<br/><b>Casos:</b> ' + markers[i].cases + '<br/><b>Mortes:</b> ' + markers[i].deaths + '<br/><b>Recuperados:</b> ' + markers[i].recovered + '<br/><b>Casos Graves (UTI):</b> ' + markers[i].serious + '<br/><b>Primeiro Caso:</b> ' + moment(markers[i].first_case).format("DD [de] MMMM [de] YYYY");
      var m = L.circleMarker([markers[i].city.lat, markers[i].city.lng], {
        color: "#e74c3c",
        radius: markers[i].city.radius,
        cases: markers[i].cases
      }).bindPopup(popup);
...
__webpack_require__(/*! F:\Projetos\mapadocoronavirus\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! F:\Projetos\mapadocoronavirus\resources\sass\app.scss */"./resources/sass/app.scss");
